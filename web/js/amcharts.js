    ...
    d.wrappedText = function (a, b, c, e, h, f, g, k, l) {
        ...
        if (m) {
            ...
            if (q.width > k) {
                ...
                m.remove();
                for (var m = [], p = 0; - 1 < (p = b.indexOf(" ", p)); )
                    m.push(p), p += 1;
                for (var t, p = 0; p < m.length; p += Math.ceil(m.length / q))
                    t = m[p], b = b.substr(0, t) + n + b.substr(t + 1);
                if (isNaN(t)) {
                    if (0 === l)
                        for (p = 1; p < q; p++)
                            t = Math.round(b.length / q * p), b = b.substr(0, t) + n +
                                    b.substr(t);
...
(function () {
    ...
    d.AxisBase = d.Class({construct: function (a) {
            ...
            var b = a.graphics.getBBox(), c = b.x + b.width / 2, b = b.y + b.height / 2, e = a.fillColor;
            ...
            var u, z = this.gridAlpha, y, v = this.choosePeriod(0), w = v.period, v = v.count, A = d.getPeriodDuration(w, v);
            A < k && (w = g.period, v = g.count, A = k);
            g = w;
            "WW" == g && (g = "DD");
            this.stepWidth = this.getStepWidth(this.timeDifference);
            var B = Math.ceil(this.timeDifference / A) + 5, D = l = d.resetDateToMin(new Date(this.startTime - A), w, v, t).getTime();
            ...
            if (0 < this.gridCountR)
                for (a = k; a <= B; a++) {
                    ...
                    if (!isNaN(u))
                        for (h = 1; h < v; h += u)
                            this.gridAlpha = this.minorGridAlpha, f = p + y * h, f = d.resetDateToMin(new Date(f), w, u, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth), this.pushAxisItem(f);
                    this.gridAlpha = z
                }
...
(function () {
    ...
    d.ValueAxis = d.Class({inherits: d.AxisBase, construct: function (a) {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)
                ...
                var t = Math.round((this.maxCalc - this.minCalc) / this.step) + 1, r;
                ...
                var y, v = this.guides, w = v.length;
                if (0 < w) {
                    var A = this.fillAlpha;
                    for (g = this.fillAlpha = 0; g < w; g++) {
                        var B = v[g], D = NaN, C = B.above;
                        ...
                        if (c = u * g + this.minCalc, h && this.max - this.min > 10 * this.min && (c -= this.min), c = d.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c)
                            if (isNaN(z) || Number(d.toFixed(c, z)) == c) {
                                ...
                                if (!isNaN(H) && 0 < v && g < t - 1) {
                                    ...
                                    for (y = 1; y < u / H; y++)
                                        w = this.getCoordinate(c + H * y), w = new this.axisItemRenderer(this, w, "", !1, 0, 0, !1, !1, 0, !0), this.pushAxisItem(w);
                                    this.gridAlpha = f
                                }
                            }
                r = this.baseValue;
            ...
            for (var e = Math.floor(Math.log(Math.abs(a)) * Math.LOG10E), h = 0; h < c.length; h++) {
                var d = a / c[h], g = Math.floor(Math.log(Math.abs(d)) * Math.LOG10E);
                if (!(0 < Math.abs(e - g)))
                    if (1 > a) {
                        if (g = Math.pow(10, -g) * d, g == Math.round(g))
                            return d
            ...
            "100% stacked" == b && (b = "100%");
            this.stackType = b;
            var c = [], e = [], h = [], f = [], g, k = this.chart.graphs, l, m, n, q, p = this.baseValue, t = !1;
            ...
            var c, e;
            for (e = a; e <= b; e++) {
                var h = this.data[e].axes[this.id].graphs, d;
                for (d in h)
                ...
                for (e in c)
                    if (c.hasOwnProperty(e)) {
                        ...
                        if (h.includeInMinMax && (!h.hidden || this.includeHidden)) {
                            ...
                            var d;
                            if (this.minMaxField)
                                d = h[this.minMaxField], d > a && (a = d);
                            else
                                for (var g in h)
                                    h.hasOwnProperty(g) && "percents" != g && "total" != g && (d = h[g], d > a && (a = d))
                        }
                    }
            }
            return a
            ...
            if (isNaN(a))
                return NaN;
            var b = this.axisWidth, c = this.stepWidth, e = this.reversed, h = this.rotate, d = this.min, g = this.minReal;
...
(function () {
    var d = window.AmCharts;
    d.RecItem = d.Class({construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
            b = Math.round(b);
            var p = a.chart;
            this.value = c;
            void 0 == c && (c = "");
            ...
            void 0 == u && (u = p.color);
            void 0 !== n && (u = n);
            var z = a.chart.container, y = z.set();
            this.set = y;
            var v = a.axisThickness, w = a.axisColor, A = a.axisAlpha, B = a.tickLength, D = a.gridAlpha, C = a.gridThickness, J = a.gridColor, H = a.dashLength, I = a.fillColor, T = a.fillAlpha, da = a.labelsEnabled;
            n = a.labelRotation;
            var pa = a.counter, U = a.inside, na = a.labelOffset, qa = a.dx, ja = a.dy, Pa = a.orientation, aa = a.position, Z = a.previousCoord, V = a.viH, sa = a.viW, ba = a.offset, ca, ta;
            ...
            var ia = "start";
            h && (ia = "middle");
            var P = n * Math.PI / 180, W, wa, G = 0, x = 0, ka = 0, ea = W = 0, Qa = 0;
            "V" == Pa && (n = 0);
            var Y;
            ...
            Y && (Y.attr({"text-anchor": ia}), Y.translate(G, x), 0 !== n && Y.rotate(-n, a.chart.backgroundColor), a.allLabels.push(Y), this.label = Y, d.setCN(p, Y, a.bcn + "label"), d.setCN(p, Y, q, !0), g && d.setCN(p, Y, "guide"));
...
(function () {
    ...
    d.AmChart = d.Class({construct: function (a) {
            ...
            if (b = this.backgroundImage)
                this.path && (b = this.path + b), a = a.image(b, 0, 0, h, f), d.setCN(this, b, "bg-image"), this.bgImg = a, e.push(a)
        }, drawTitles: function () {
            var a = this.titles;
            if (d.ifArray(a)) {
                var b = 20, c;
                for (c = 0; c < a.length; c++) {
                    var e = a[c], e = d.processObject(e, d.Title, this.theme);
                    if (!1 !== e.enabled) {
                        var h = e.color;
                        ...
                        isNaN(e.alpha);
                        var g = this.marginLeft, h = d.text(this.container, e.text, h, this.fontFamily, f);
            ...
            if (this.animations)
                for (a = this.animations.length - 1; 0 <= a; a--) {
                    var b = this.animations[a], c = 1E3 * b.time / d.updateRate, e = b.frame + 1, h = b.obj, f = b.attribute;
                    if (e <= c) {
                        b.frame++;
            ...
            if ("amcharts.com" != b || !0 === this.inIframe()) {
                var c = b = 0, e = this.realWidth, d = this.realHeight, f = this.type;
                if ("serial" == f || "xy" == f || "gantt" == f)
                    b = this.marginLeftReal, c = this.marginTopReal, e = b + this.plotAreaWidth, d = c + this.plotAreaHeight;
                ...
                g.opacity = .7;
                g.display = "block";
                var k = f.offsetWidth, f = f.offsetHeight, l = 5 + b, m = c + 5;
...
(function () {
    ...
    d.AmGraph = d.Class({construct: function (a) {
            ...
            for (d = this.start; d <= this.end; d++) {
                var f = this.data[d].axes[c.id].graphs[this.id], g = f.values, k = g.x, l = g.y, g = c.getCoordinate(k), m = e.getCoordinate(l);
            ...
            var a = this.valueAxis.stackType, b = [], c = [], e, d, f;
            for (f = this.start; f <= this.end; f++) {
                var g = this.data[f].axes[this.valueAxis.id].graphs[this.id], k;
                k = "none" == a || "3d" == a ? g.values.value : g.values.close;
                if (isNaN(k))
                    this.drawLineGraph(b, c), b = [], c = [];
                else {
                    var l = this.y - (this.valueAxis.getCoordinate(k) - this.height), m = 180 - 360 / (this.end - this.start + 1) * f;
                    k = l * Math.sin(m / 180 * Math.PI);
                    l *= Math.cos(m / 180 * Math.PI);
                    b.push(k);
                    c.push(l);
                    var m = this.createBullet(g, k, l, f), n = this.labelText;
            ...
            if (e) {
                var l = e.graphDataItem, m = this.chart.rotate, n = l.isNegative, q = this.chart;
                b -= k.height / 4 / 2;
                switch (g) {
                    case"top":
                ...
                var p = l.columnGraphics, t = 0, r = 0;
                p && (t = p.x, r = p.y);
            ...
            isNaN(k) && (k = .8);
            var m = this.useNegativeColorIfDown, n = this.width, q = this.height, p = this.y, t = this.rotate, r = this.columnCount, u = d.toCoordinate(this.cornerRadiusTop, k / 2), z = this.connect, y = [], v = [], w, A, B, D, C = this.chart.graphs.length, J, H = this.dx / this.tcc, I = this.dy / this.tcc, T = f.stackType, da = this.start, pa = this.end, U = this.scrollbar, na = "graph-column-";
            U && (na = "scrollbar-graph-column-");
            var qa = this.categoryAxis, ja = this.baseCoord, Pa = this.negativeBase, aa = this.columnIndex, Z = this.lineThickness, V = this.lineAlpha, sa = this.lineColorR, ba = this.dashLength, ca = this.set, ta, ia = this.getGradRotation(), P = this.chart.columnSpacing, W = qa.cellWidth, wa = (W * k - r) / r;
            P > wa && (P = wa);
            var G, x, ka, ea = q + 1, Qa = n + 1, Y = 0, qb = 0, rb, sb, eb, fb, tb = this.fillColorsR, Ja = this.negativeFillColors, Ca = this.negativeLineColor, Wa = this.fillAlphas, Xa = this.negativeFillAlphas;
            ...
            if (!(U || "line" != g && "smoothedLine" != g && "step" != g || (1 == e.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Ja && void 0 == Ca || m))) {
                ...
                var Ga = f.getCoordinate(Ra), Ib = f.getCoordinate(f.max);
            ...
            var Q = [], R = [], Ka = !1;
            if ("line" == g || "step" == g || "smoothedLine" == g)
                if (this.stackable && "regular" == T || "100%" == T || this.fillToGraph)
                    Ka = !0;
            var Kb = this.noStepRisers, hb = -1E3, ib = -1E3, jb = this.minDistance, La = !0, Ya = !1;
            for (K = da; K <= pa; K++) {
                G = e[K];
                ...
                if (m && void 0 == this.openField)
                    for (var ub = K + 1; ub < e.length && (!e[ub] || !(Za = e[K + 1].axes[f.id].graphs[b]) || !Za.values || (Ma = Za.values.value, isNaN(Ma))); ub++)
                        ;
                var S, O, M, fa, la = NaN, F = NaN, E = NaN, N = NaN, L = NaN, Na = NaN, Da = NaN, Oa = NaN, Ea = NaN, ya = NaN, za = NaN, ga = NaN, ha = NaN, X = NaN, vb = NaN, wb = NaN, ma = NaN, oa = void 0, Ia = tb, Sa = Wa, Aa = sa, ua, xa, xb = this.proCandlesticks, kb = this.topRadius, $a = this.pattern;
                ...
                if (Ba) {
                    ...
                    if ("candlestick" == g || "ohlc" == g)
                        X = Ba.close, wb = Ba.low, Da = f.getCoordinate(wb), vb = Ba.high, Ea = f.getCoordinate(vb);
                    ma = Ba.open;
                    E = f.getCoordinate(X);
                    ...
                    var la = G.x[qa.id], Ta = this.periodSpan - 1, ra = Math.floor(W / 2) + Math.floor(Ta * W / 2), Fa = ra, lb = 0;
                    ...
                    if (!xb && X < ma || xb && X < ta)
                        x.isNegative = !0, Ja && (Ia = Ja), Xa && (Sa = Xa), void 0 != Ca && (Aa = Ca);
                    Ya = !1;
                    ...
                    switch (g) {
                        case"line":
                            if (isNaN(X))
                                z || (this.drawLineGraph(y, v, Q, R), y = [], v = [], Q = [], R = []);
                            else {
                                if (Math.abs(F - hb) >= jb || Math.abs(E - ib) >= jb)
                                    y.push(F), v.push(E), hb = F, ib = E;
                                ya = F;
                                za = E;
                                ga = F;
                                ha = E;
                                ...
                                if (Ya || void 0 != x.lineColor || void 0 != x.fillColors || !isNaN(x.dashLength))
                                    this.drawLineGraph(y, v, Q, R), y = [F], v = [E], Q = [], R = [], !Ka || isNaN(L) || isNaN(N) || (Q.push(N), R.push(L)), m ? La ? (this.lineColorSwitched = sa, this.fillColorsSwitched = tb) : (this.lineColorSwitched = Ca, this.fillColorsSwitched = Ja) : (this.lineColorSwitched = x.lineColor, this.fillColorsSwitched = x.fillColors), this.dashLengthSwitched = x.dashLength;
                                x.gap && (this.drawLineGraph(y, v, Q, R), y = [], v = [], Q = [], R = [])
                            }
                            break;
                        case"smoothedLine":
                            if (isNaN(X))
                                z || (this.drawSmoothedGraph(y, v, Q, R), y = [], v = [], Q = [], R = []);
                            else {
                                if (Math.abs(F - hb) >= jb || Math.abs(E - ib) >= jb)
                                    y.push(F), v.push(E), hb = F, ib = E;
                                ya = F;
                        ...
                        case"step":
                            if (!isNaN(X)) {
                                ...
                                ha = E;
                                if (Ya || void 0 != x.lineColor || void 0 != x.fillColors || !isNaN(x.dashLength)) {
                                    var Yb = y[y.length - 2], Zb = v[v.length - 2];
                                    y.pop();
                                    v.pop();
                                ...
                                if (Kb || x.gap)
                                    w = A = NaN, this.drawLineGraph(y, v, Q, R), y = [], v = [], Q = [], R = []
                            } else if (!z) {
                                if (1 >= this.periodSpan || 1 < this.periodSpan && F - w > ra + Fa)
                                    w = A = NaN;
                                this.drawLineGraph(y, v, Q, R);
                                y = [];
                                v = [];
                        ...
                        case"column":
                            ...
                            if (!isNaN(X)) {
                                ...
                                if (oa && (xa = oa.set, d.setCN(a, oa.set, "graph-" + this.type), d.setCN(a, oa.set, "graph-" + this.id), x.className && d.setCN(a, oa.set, x.className, !0), x.columnGraphics = xa, xa.translate(S, O), this.columnsSet.push(xa), (x.url || this.showHandOnHover) && xa.setAttr("cursor", "pointer"), !U)) {
                                    ...
                                    if ("regular" == T || "100%" == T)
                                        J = t ? 0 < Ba.value ? (this.end + 1 - K) * C + c : (this.end + 1 - K) * C - c : 0 < Ba.value ? C * K + c : C * K - c;
                        ...
                        case"candlestick":
                            if (!isNaN(ma) && !isNaN(X)) {
                                ...
                                if (t) {
                                    ...
                                    xb && X >= ma && (Sa = 0);
                                    var oa = new d.Cuboid(h, M, fa, H, I, Ia, Sa, Z, ua, V, ia, u, t, ba, $a, kb, na), Bb, Cb;
                        ...
                        case"ohlc":
                            if (!(isNaN(ma) || isNaN(vb) || isNaN(wb) || isNaN(X))) {
                                ...
                                var mb, nb, ob;
                                if (t) {
                                    var Db = E - k / 2, Db = d.fitToBounds(Db, 0, q), Ob = d.fitToBounds(E, 0, q), Eb = E + k / 2, Eb = d.fitToBounds(Eb, 0, q);
                                    ...
                                    var Fb = F - k / 2, Fb = d.fitToBounds(Fb, 0, n), Pb = d.fitToBounds(F, 0, n), Gb = F + k / 2, Gb = d.fitToBounds(Gb, 0, n);
                    ...
                    if (!U && !isNaN(X)) {
                        ...
                        if (this.end - this.start <= Qb || 0 === Qb) {
                            var Rb = this.createBullet(x, ga, ha, K), Sb = this.labelText;
                            if (Sb && Rb) {
                            ...
                            if ("regular" == T || "100%" == T) {
                                ...
                                if (Tb) {
                                    ...
                                    var Ub = Va.getBBox(), Vb = Ub.width, Wb = Ub.height, bb, cb, pb = f.totalTextOffset, Xb = f.totals[K];
                                    Xb && Xb.remove();
                                    var db = 0;
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g)
                "smoothedLine" == g ? this.drawSmoothedGraph(y, v, Q, R) : this.drawLineGraph(y, v, Q, R), U || this.launchAnimation();
            ...
            if (1 < a.length) {
                ...
                f.push(m);
                f.push(l);
                var n = h.lineAlpha, q = h.lineThickness, f = h.fillAlphas, p = h.lineColorR, t = h.negativeLineAlpha;
                isNaN(t) && (t = n);
                var r = h.lineColorSwitched;
                r && (p = r);
                var r = h.fillColorsR, u = h.fillColorsSwitched;
                u && (r = u);
                var z = h.dashLength;
                (u = h.dashLengthSwitched) && (z = u);
                var u = h.negativeLineColor, y = h.negativeFillColors, v = h.negativeFillAlphas, w = h.baseCoord;
                ...
                if (0 < f || 0 < v)
                    if (q = a.join(";").split(";"), t = b.join(";").split(";"), n = g.type, "serial" == n ? 0 < c.length ? (c.reverse(), e.reverse(), q = a.concat(c), t = b.concat(e)) : h.rotate ? (t.push(t[t.length - 1]), q.push(w), t.push(t[0]), q.push(w), t.push(t[0]), q.push(q[0])) : (q.push(q[q.length - 1]), t.push(w), q.push(q[0]), t.push(w), q.push(a[0]), t.push(t[0])) : "xy" == n && (b = h.fillToAxis) && (d.isString(b) && (b = g.getValueAxisById(b)), "H" == b.orientation ? (w = "top" == b.position ? 0 : b.viH, q.push(q[q.length - 1]), t.push(w), q.push(q[0]), t.push(w), q.push(a[0]), t.push(t[0])) : (w = "left" == b.position ? 0 : b.viW, t.push(t[t.length - 1]), q.push(w), t.push(t[0]), q.push(w), t.push(t[0]), q.push(q[0]))), a = h.gradientRotation, 0 < f && (b = d.polygon(k, q, t, r, f, 1, "#000", 0, a), b.pattern(h.pattern), d.setCN(g, b, h.bcn + "fill"), l.push(b)), y || void 0 !== u)
                        isNaN(v) && (v = f), y || (y = u), k = d.polygon(k, q, t, y, v, 1, "#000", 0, a), d.setCN(g, k, h.bcn + "fill"), d.setCN(g, k, h.bcn + "fill-negative"), k.pattern(h.pattern), m.push(k), m.click(function (a) {
                            h.handleGraphEvent(a, "clickGraph")
                        }).mouseover(function (a) {
                            h.handleGraphEvent(a, "rollOverGraph")
                        }).mouseout(function (a) {
            ...
            if (1 < a.length) {
                ...
                h.push(l);
                h.push(k);
                var m = this.lineAlpha, n = this.lineThickness, h = this.dashLength, q = this.fillAlphas, p = this.lineColorR, t = this.fillColorsR, r = this.negativeLineColor, u = this.negativeFillColors, z = this.negativeFillAlphas, y = this.baseCoord, v = this.lineColorSwitched;
                v && (p = v);
...
(function () {
    ...
    d.ChartCursor = d.Class({construct: function (a) {
            ...
            var a = this.cursorAlpha, b = this.container, c = d.line(b, [0, 0], [0, this.height], this.cursorColor, a, 1), a = d.line(b, [0, this.width], [0, 0], this.cursorColor, a, 1);
            ...
            var c = this.chart, e = this.fullWidth, h = c.mouseX -
                    this.x, f = c.mouseY - this.y;
            ...
            if (this.enabled) {
                ...
                var g = c.categoryAxis, k = c.dx, l = c.dy, m = this.x + 1, n = this.y + 1, q = this.width, p = this.height, t = this.data[a];
                this.fireMoved();
                if (t) {
                    var r = t.x[g.id], u = c.rotate, z = this.stepWidth, y = this.categoryBalloon, v = this.firstTime, w = this.lastTime, A = this.cursorPosition, B = this.zooming, D = this.panning, C = c.graphs;
                    if (c.mouseIsOver || B || D || this.forceShow)
                        if (this.forceShow = !1, D) {
                            var k = this.panClickPos, c = this.panClickEndTime, B = this.panClickStartTime, J = this.panClickEnd, m = this.panClickStart, h = (u ? k - f : k - h) / z;
                            ...
                            v = this.line;
                            0 < this.cursorAlpha && (u ? (w = 0, z = r + l, e && (z -= g.cellWidth / 2)) : (w = r, z = 0, e && (w -= g.cellWidth / 2)), A = this.animationDuration, 0 < A && !this.zooming ? isNaN(this.previousX) ? v.translate(w, z) : (v.translate(this.previousX, this.previousY), v.animate({translate: w + "," + z}, A, "easeOutSine")) : v.translate(w, z), this.previousX = w, this.previousY = z, v.show());
                            ...
                            if (this.oneBalloonOnly) {
                                ...
                                for (g = 0; g < C.length; g++)
                                    y = C[g], y.showBalloon && !y.hidden && y.balloonText && (v = t.axes[y.valueAxis.id].graphs[y.id], w = v.y, isNaN(w) || (u ? Math.abs(h - w) < r && (r = Math.abs(h - w), J = y) : Math.abs(f - w) < r && (r = Math.abs(f - w), J = y)));
                                ...
                                if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], C && this.valueBalloonsEnabled && z && c.balloon.enabled) {
                                    ...
                                    for (g = 0; g < C.length; g++)
                                        if (y = C[g], w = NaN, (!this.oneBalloonOnly || y == J) && y.showBalloon && !y.hidden && y.balloonText && ("step" == y.type && "left" == y.stepDirection && (t = this.data[a + 1]), t)) {
                                            if (v = t.axes[y.valueAxis.id].graphs[y.id])
                                                w = v.y;
                                            if (this.showNextAvailable && isNaN(w) && a + 1 < this.data.length)
                                                for (z = a + 1; z < this.data.length; z++)
                                                    if (e = this.data[z])
                                                        if (v = e.axes[y.valueAxis.id].graphs[y.id], w = v.y, !isNaN(w))
                                                            break;
                                            if (!isNaN(w)) {
                                                e = v.x;
                                                l = !0;
                            ...
                            b ? (k = {type: "changed"}, k.index = a, k.chart = this.chart, k.zooming = B, k.mostCloseGraph = J, k.position = u ? f : h, k.target = this, c.fire("changed", k), this.fire("changed", k), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
            ...
            if (a) {
                ...
                if (this.drawingNow) {
                    ...
                    if (2 < Math.abs(c - e) || 2 < Math.abs(f - h))
                        c = {type: "draw", target: this, chart: a, initialX: c, initialY: f, finalX: e, finalY: h}, this.fire(c.type, c)
                }
            ...
            if (this.zoomable || this.pan || this.drawing) {
                ...
                if (0 < e && e < this.width && 0 < h && h < this.height || "fake" == a)
                    this.setPosition(), this.selectWithoutZooming && d.remove(this.selection), this.drawing ? (this.drawStartY = h, this.drawStartX = e, this.drawingNow = !0) : this.pan ? (this.zoomable = !1, c.setMouseCursor("move"), this.panning = !0, this.panClickPos = b ? h : e, this.panClickStart = this.start, this.panClickEnd = this.end, this.panClickStartTime = this.startTime, this.panClickEndTime = this.endTime) : this.zoomable && ("cursor" == this.type ? (this.fromIndex = this.index, b ? (this.initialMouse = h, this.selectionPosY = this.linePos) : (this.initialMouse = e, this.selectionPosX = this.linePos)) : (this.initialMouseX = e, this.initialMouseY = h, this.selectionPosX = e, this.selectionPosY = h), this.zooming = !0)
            }
        }})
})();
(function () {
    ...
    d.SimpleChartScrollbar = d.Class({construct: function (a) {
            ...
            a.destroy();
            if (a.enabled) {
                var b = a.chart.container, c = a.rotate, e = a.chart, h = b.set();
                a.set = h;
            ...
            if (k) {
                c = k.x + d;
                e = k.y + f;
                var l = k.width, k = k.height, m = this.rotate, n = this.chart, q = this.width, p = this.height, t = n.mouseX, r = n.mouseY;
                a = this.initialMouse;
    ...
    d.ChartScrollbar = d.Class({inherits: d.SimpleChartScrollbar, construct: function (a) {
            ...
            if (this.skipEvent)
                ...
                if (k.parseDates && !k.equalSpacing) {
                    if (a = g.lastTime, g = g.firstTime, k = Math.round(b / l) + g, b = this.dragging ? k + this.timeDifference : Math.round((b + c) / l) + g, k > b && (k = b), 0 < d && b - k < d && (b = Math.round(k + (b - k) / 2), e = Math.round(d / 2), k = b - e, b += e, e = !0), b > a && (b = a), b - d < k && (k = b - d), k < g && (k = g), k + d > b && (b = k + d), k != this.startTime || b != this.endTime)
                        this.startTime = k, this.endTime = b, f.start = k, f.end = b, f.startDate = new Date(k), f.endDate = new Date(b), this.fire(f.type,
                                f)
                } else if (k.startOnAxis || (b += l / 2), c -= this.stepWidth / 2, d = k.xToIndex(b), b = k.xToIndex(b + c), d != this.start || this.end != b)
                    k.startOnAxis && (this.resizingRight && d == b && b++, this.resizingLeft && d == b && (0 < d ? d-- : b = 1)), this.start = d, this.end = this.dragging ? this.start + this.difference : b, f.start = this.start, f.end = this.end, k.parseDates && (a[this.start] && (f.startDate = new Date(a[this.start].time)), a[this.end] && (f.endDate = new Date(a[this.end].time))), this.fire(f.type, f);
    ...
    d.AmBalloon = d.Class({construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var r = this.horizontalPadding, u = this.verticalPadding, z = this.pointerWidth, y = this.pointerOrientation, v = this.cornerRadius, w = c.fontFamily, A = this.fontSize;
                    ...
                    D < g && (D = g);
                    D + C > l && (D = l - C);
                    var k = A + u, m = D + r, u = this.shadowAlpha, H = this.shadowColor, r = this.borderThickness, I = this.bulletSize, T;
                    ...
                    0 < this.animationDuration && !e && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY), f.animate({translate: D - h + "," + A}, b, "easeOutSine"), n && (B.left = this.prevTX + "px", B.top = this.prevTY + "px", this.xAnim = c.animate({node: n}, "left", this.prevTX, m, b, "easeOutSine", "px"), this.yAnim = c.animate({node: n}, "top", this.prevTY, k, b, "easeOutSine", "px")));
                    this.prevX = D - h;
                    this.prevY = A;
                    this.prevTX = m;
                    this.prevTY = k
    ...
    d.AmCoordinateChart = d.Class({inherits: d.AmChart, construct: function (a) {
            ...
            if (a) {
                ...
                for (z = 0; z < a.length; z++) {
                    ...
                    m && (w.labelColor = A[m]);
                    u[A[h]] = w;
                    if (f && (k.categoryFunction ? c = k.categoryFunction(c, A, k) : (!y || c instanceof Date || (c = c.toString()), c = d.getDate(c, y, k.minPeriod)), c = d.resetDateToMin(c, q, p, k.firstDayOfWeek), w.category = c, w.time = c.getTime(), isNaN(w.time)))
                        continue;
            ...
            var e = a.lineColor, d = a.balloonColor;
            c && (d = e);
            c = a.fillColorsR;
...
(function () {
    var d = window.AmCharts;
    d.AmSlicedChart = d.Class({inherits: d.AmChart, construct: function (a) {
            ...
            !0 === c && (e = 0);
            (c = a.wedge) && (0 < e ? c.animate({translate: b * a.pullX + "," + b * a.pullY}, e, this.pullOutEffect) : c.translate(b * a.pullX, b * a.pullY));
            ...
            if (void 0 !== b) {
                ...
                1 < b && (this.groupValue = 0, this.removeSmallSlices(), a.push({title: this.groupedTitle, value: this.groupValue, percents: this.groupValue /
                            e * 100, pulled: this.groupedPulled, color: this.groupedColor, url: this.groupedUrl, description: this.groupedDescription, alpha: this.groupedAlpha, pattern: this.groupedPattern, className: this.groupedClassName, dataContext: {}}));
                c = this.baseColor;
...
(function () {
    var d = window.AmCharts;
    d.AmRectangularChart = d.Class({inherits: d.AmCoordinateChart, construct: function (a) {
            ...
            if (a = this.categoryAxis)
                b = this.getAxisBounds(a, g, l, k, b), g = Math.round(b.l), l = Math.round(b.r), k = Math.round(b.t), b = Math.round(b.b);
            ...
            var c = a.color, e = a.fontSize, h = a.zoomOutButtonImageSize, f = a.zoomOutButtonImage, g = d.lang.zoomOutText || a.zoomOutText, k = a.zoomOutButtonColor, l = a.zoomOutButtonAlpha, m = a.zoomOutButtonFontSize, n = a.zoomOutButtonPadding;
            isNaN(m) || (e = m);
            ...
            var a = this.dx, b = this.dy, c = this.marginLeftReal, e = this.marginTopReal, h = this.plotAreaWidth - 1, f = this.plotAreaHeight - 1, g = this.plotAreaFillColors, k = this.plotAreaFillAlphas, l = this.plotAreaBorderColor, m = this.plotAreaBorderAlpha;
            ...
            0 !== a && 0 !== b && (g = this.plotAreaFillColors, "object" == typeof g && (g = g[0]), g = d.adjustLuminosity(g, -.15), h = d.polygon(this.container, [0, a, h + a, h, 0], [0, b, b, 0, 0], g, k, 1, l, m), d.setCN(this, h, "plot-area-bottom"), h.translate(c, e + f), this.set.push(h), a = d.polygon(this.container, [0, 0, a, a, 0], [0, f, f +
                        b, b, 0], g, k, 1, l, m), d.setCN(this, a, "plot-area-left"), a.translate(c, e), this.set.push(a));
            ...
            if (a) {
                a.rotate = b;
                var c = this.marginTopReal, e = this.marginLeftReal, d = a.scrollbarHeight, f = this.dx, g = this.dy, k = a.offset;
...
(function () {
    ...
    d.TrendLine = d.Class({construct: function (a) {
            ...
            var a = this;
            a.destroy();
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory, n = a.finalDate, q = a.finalCategory, p = a.valueAxis, t = a.valueAxisX, r = a.initialXValue, u = a.finalXValue, z = a.initialValue, y = a.finalValue, v = p.recalculateToPercents, w = b.dataDateFormat;
...
(function () {
    ...
    d.makeHD = function (a, b, c) {
        for (var e = [], d = [], f = 1; f < a.length; f++)
            for (var g = Number(a[f - 1]), k = Number(b[f - 1]), l = Number(a[f]), m = Number(b[f]), n = Math.sqrt(Math.pow(l - g, 2) + Math.pow(m - k, 2)), n = Math.round(n / 50) + 1, l = (l - g) / n, m = (m - k) / n, q = 0; q <= n; q++) {
                var p = g + q * l + Math.random() * c, t = k + q * m + Math.random() * c;
                e.push(p);
                d.push(t)
            }
        return[e, d]
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q) {
        ...
        g = p(g);
        k = p(k);
        var t = p(g / f * k), r = d.VML, u = 359.5 + f / 100;
        359.94 < u && (u = 359.94);
        h >= u && (h = u);
        var z = 1 / 180 * Math.PI, u = b + Math.sin(e * z) * k, y = c - Math.cos(e * z) * t, v = b + Math.sin(e * z) * f, w = c - Math.cos(e * z) * g, A = b + Math.sin((e + h) * z) * f, B = c - Math.cos((e + h) * z) * g, D = b + Math.sin((e + h) * z) * k, z = c - Math.cos((e + h) * z) * t, C = {fill: d.adjustLuminosity(m.fill, -.2), "stroke-opacity": 0, "fill-opacity": m["fill-opacity"]}, J = 0;
        180 < Math.abs(h) && (J = 1);
        e = a.set();
        var H;
    ...
    d.adjustLuminosity = function (a, b) {
        ...
        var c = "#", e, d;
        for (d = 0; 3 > d; d++)
            e = parseInt(a.substr(2 * d, 2), 16), e = Math.round(Math.min(Math.max(0, e + e * b), 255)).toString(16), c += ("00" + e).substr(e.length);
        return c
    }
})();
(function () {
    var d = window.AmCharts;
    d.Bezier = d.Class({construct: function (a, b, c, e, h, f, g, k, l, m) {
            ...
            var h = Math.round, f = this.getPointOnSegment(a, b, .75), g = this.getPointOnSegment(d, c, .75), k = (d.x - a.x) / 16, l = (d.y - a.y) / 16, m = this.getPointOnSegment(a, b, .375);
...
(function () {
    ...
    d.SVGRenderer = d.Class({construct: function (a) {
            ...
            var h = a.patternNode;
            h && this.D.remove(h);
            var h = document.createElementNS(d.SVG_NS, "pattern"), f = d.getUniqueId(), g = b;
            b.url && (g = b.url);
...
AmCharts.AmDSet = AmCharts.Class({construct: function (d) {
        this.create("g")
    }, attr: function (d) {
...
(function () {
    ...
    d.AmLegend = d.Class({construct: function (a) {
            ...
            this.titleWidth = 0;
            if (h = this.title)
                h = d.text(this.container, h, this.color, a.fontFamily, this.fontSize, "start", !0), d.setCN(a, h, "legend-title"), h.translate(this.marginLeft, this.marginTop + this.verticalGap + this.ly + 1), a = h.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height + 6;
            ...
            var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, e = this.marginTop, h = this.marginBottom, f = this.horizontalGap, g = this.div, k = this.divWidth, l = this.maxColumns, m = this.verticalGap, n = this.spacing, q = k - c - b, p = 0, t = 0, r = this.container;
            this.set && this.set.remove();
            var u = r.set();
            this.set = u;
            var z = r.set();
            u.push(z);
            var y = this.entries, v, w;
            ...
            if (!1 !== a.visibleInLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c)
                        ...
                        n = a.fillColorsR;
                        !0 === a.hidden && (n = e);
                        if (g = this.createMarker("rectangle", n, a.fillAlphas, a.lineThickness, e, a.lineAlpha, t, g))
                            p = m, g.translate(p, m / 2);
                        n = m
                    }
                    d.setCN(b, g, "graph-" + c);
                    d.setCN(b, g, "graph-" + a.id)
                } else
                    k ? (b.path && (k = b.path + k), g = l.image(k, 0, 0, m, m)) : (g = this.createMarker(c, e, h, void 0, void 0, void 0, void 0, g)) && g.translate(m / 2, m / 2);
...
(function () {
    ...
    d.formatDate = function (a, b, c) {
        ...
        var q = String(e).substr(2, 2), p = h + 1;
        9 > h && (p = "0" +
                p);
        var t = "0" + g;
        b = b.replace(/W/g, n);
