    ...
    h.AmPieChart = h.Class({inherits: h.AmSlicedChart, construct: function (d) {
            ...
            if (h.ifArray(d)) {
                if (0 < this.realWidth && 0 < this.realHeight) {
                    ...
                    this.realHeight = m;
                    var e = h.toCoordinate, k = e(this.marginLeft, b), a = e(this.marginRight, b), v = e(this.marginTop, m) + this.getTitleHeight(), n = e(this.marginBottom, m), y, z, g, x = h.toNumber(this.labelRadius), q = this.measureMaxLabel();
